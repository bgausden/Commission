...
for (const key of sortedKeys) {
  ...
  console.log(
    `   File 1 (local):       HK$ ${amount1.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
  );
  console.log(
    `   File 2 (Google Drive): HK$ ${amount2.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
  );

  if (Math.abs(diff) > 0.01) {
    console.log(
      `   Difference:           HK$ ${diff.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2, signDisplay: "always" })}`,
    );
  }
...
console.log("TOTALS:");
console.log(
  `   File 1 (local):       HK$ ${totalFile1.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
);
console.log(
  `   File 2 (Google Drive): HK$ ${totalFile2.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
);
console.log(
  `   Difference:           HK$ ${(totalFile1 - totalFile2).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2, signDisplay: "always" })}`,
);
console.log("═".repeat(100));
