...
function calcServiceCommission(staffID, serviceRev) {
    ...
    if (shm.has(staffID)) {
        ...
        const tempServComm = Object.assign({}, emptyServComm, { base: Object.assign({}, emptyServComm.base), hurdle1: Object.assign({}, emptyServComm.hurdle1), hurdle2: Object.assign({}, emptyServComm.hurdle2), hurdle3: Object.assign({}, emptyServComm.hurdle3) });
...
function createPaymentSpreadsheet(cm, sm) {
    ...
    cm.forEach((commMapEntry, sid) => {
        ...
        if (staffMapEntry === undefined) {
            ...
            paymentProto = Object.assign({}, emptyTalenoxPayment, { 
    ...
    const paymentsWS = xlsx_1.default.utils.json_to_sheet(payments, { skipHeader: true });
    xlsx_1.default.utils.book_append_sheet(paymentsWB, paymentsWS, PAYMENTS_WS_NAME);
    xlsx_1.default.writeFile(paymentsWB, PAYMENTS_WB_NAME);
}
function main() {
                    ...
                    if (payComponent !== undefined) {
                        ...
                        if (payComponent === TIPS_FOR ||
                            ...
                            if (payComponent.slice(0, TOTAL_FOR.length) ===
                                ...
                                value = calcServiceCommission(staffID, serviceRevenue);
